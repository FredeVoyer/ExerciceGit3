$(document).ready(function () {
    ...
    //typo standard add price for each case
    ...
    // construct prodRange declared??? yes above
    function getProdRange() {
        if ($('#standard').is(':checked')) {
            ...
            prodRange.price = parseFloat(12345); // change 123456 to 12345
    ...
    function GetInfos() {// miss getInfoNumApp
        getInfoNumApp();
        getInfoNumFloors();
        getInfoNumBase();
        getInfoNumElev();
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (prodRange.type != null) {
                    setPricesResults(data.finalNumElev, data.subTotal, data.installationFee, data.grandTotal); // add ??
                }
            }
        });
    }
